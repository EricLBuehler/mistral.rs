...
use clap::Parser;
use mistralrs_core::{
    Loader, MistralLoader, MistralRs, MistralSpecificConfig, SchedulerMethod, TokenSource,
};
...
async fn main() -> Result<()> {
    ...
    let _mistralrs = MistralRs::new(pipeline, SchedulerMethod::Fixed(2.try_into().unwrap()));
