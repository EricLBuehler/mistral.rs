...
pub struct MultimodalData {
    ...
    pub image_gen_save_path: Option<PathBuf>,
...
impl MultimodalData {
    pub fn new(
        ...
        image_gen_save_path: Option<PathBuf>,
    ) -> Self {
        MultimodalData {
    ...
    pub fn image_gen_save_path(&self) -> Option<&PathBuf> {
        self.image_gen_save_path.as_ref()
    }
...
impl Sequence {
    ...
    pub fn image_gen_save_path(&self) -> Option<&PathBuf> {
        self.multimodal.image_gen_save_path()
    }
