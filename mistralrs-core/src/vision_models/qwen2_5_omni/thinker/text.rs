...
use crate::{
    ...
    layers::{self, Activation, CausalMasker, F32RmsNorm, Qwen2_5VLRotaryEmbedding, Sdpa},
    ...
    vision_models::qwen2_5_omni::config::Qwen25OmniTextConfig,
};
...
pub struct Qwen25OThinkerTextModel {
...
impl IsqModel for Qwen25OThinkerTextModel {
    fn get_layers(
        &mut self,
    ) -> (
