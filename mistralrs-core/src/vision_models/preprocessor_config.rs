...
pub struct PreProcessorConfig {
    ...
    pub(crate) downsample_factor: Option<usize>,
    pub(crate) encoder_patch_size: Option<usize>,
    pub(crate) max_num_patches: Option<usize>,
    pub(crate) max_pixels_tolerance: Option<f64>,
    pub(crate) min_tiles: Option<usize>,
    pub(crate) max_tiles: Option<usize>,
    pub(crate) min_image_tokens: Option<usize>,
