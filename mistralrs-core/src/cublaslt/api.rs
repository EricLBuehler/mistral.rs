...
impl mcandle_core::CustomOp2 for CublasLTMatmul {
    ...
    fn cpu_fwd(
        ...
        mcandle_core::bail!("no cpu support for cublaslt-matmul")
    }
    ...
    fn cuda_fwd(
        ...
        match a.dtype() {
            ...
            dt => {
                mcandle_core::bail!("cublaslt-matmul is only supported for f16/bf16/f32 ({dt:?})")
            }
        }
    }
}
