...
impl FromStr for NormalLoaderType {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "gptoss" => Ok(Self::GPTOSS),
            a => Err(format!("Unknown architecture `{a}`. Possible architectures: `mistral`, `gemma`, `mixtral`, `llama`, `phi2`, `phi3`, `qwen2`, `gemma2`, `starcoder2`, `phi3.5moe`, `deepseekv2`, `deepseekv3`, `qwen3`, `glm4`, `qwen3moe`, `smollm3`, `gptoss`.")),
        }
    }
}
...
/// [`NormalLoader`] for a GPT-OSS Vision model.
///
/// [`NormalLoader`]: https://ericlbuehler.github.io/mistral.rs/mistralrs/struct.NormalLoader.html
...
impl NormalModelLoader for GPTOSSLoader {
    fn load(
        ...
        Ok(Box::new(crate::models::gpt_oss::GPTOSSModel::new(
            &cfg,
            vb,
            self.is_gptx(config)?,
            normal_loading_metadata,
