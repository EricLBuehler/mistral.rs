...
pub use loaders::{
    AdapterKind, AutoLoader, DeepSeekV2Loader, DeviceMappedModelLoader, DiffusionLoaderType,
    DiffusionModel, DiffusionModelLoader, FluxLoader, Gemma2Loader, GemmaLoader, Idefics2Loader,
    ...
    PrettyName, QuantizationKind, Qwen2Loader, Qwen2VLLoader, Starcoder2Loader, TokenSource,
