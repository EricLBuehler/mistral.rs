...
pub use loaders::{
    ...
    HunyuanVLLoader, Idefics2Loader, Idefics3Loader, LLaVALoader, LLaVANextLoader, Lfm2Loader,
    Lfm2VlLoader, LlamaLoader, Loader, LocalModelPaths, MiniCpmOLoader, Mistral3Loader,
