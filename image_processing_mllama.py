...
class MllamaImageProcessor(BaseImageProcessor):
    ...
    def preprocess(
        ...
        for images in images_list:
            ...
            for image in images:
                ...
                # np.save("/home/ubuntu/dump/truth/original_image.npy", image.astype(float))
                ...
                # np.save("/home/ubuntu/dump/truth/resize_image.npy", image.astype(float))
                ...
                # np.save("/home/ubuntu/dump/truth/pad_image.npy", image.astype(float))
                ...
                # np.save("/home/ubuntu/dump/truth/rescale_norm_image.npy", image.astype(float))

                num_tiles_height, num_tiles_width = aspect_ratio
                image = split_to_tiles(image, num_tiles_height, num_tiles_width)

                # np.save("/home/ubuntu/dump/truth/split_image.npy", image.astype(float))
        ...
        # np.save("/home/ubuntu/dump/truth/aspect_ratio_ids.npy", aspect_ratio_ids.astype(float))
        # np.save("/home/ubuntu/dump/truth/aspect_ratio_mask.npy", aspect_ratio_mask.astype(float))
        np.save("/home/ubuntu/dump/truth/packed_images.npy", images.astype(float))
        # print(f"{num_tiles=}")
    ...
    def resize(
        ...
        # print(f"{canvas_height=},{canvas_width=},{num_tiles_height=},{num_tiles_width=},")
