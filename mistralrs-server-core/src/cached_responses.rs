...
use crate::openai::{ResponsesObject, ResponsesChunk};
...
pub static RESPONSE_CACHE: LazyLock<Arc<dyn ResponseCache>> = LazyLock::new(|| {
...
mod tests {
    ...
    fn test_in_memory_cache() {
        ...
        // Store and retrieve
        cache.store_response("test-id".to_string(), response.clone()).unwrap();
