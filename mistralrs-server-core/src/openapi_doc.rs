...
use crate::{
    ...
    openai::{
        ...
        ResponsesError, ResponsesIncompleteDetails, ResponsesInput, ResponsesInputContentPart,
        ResponsesInputItem, ResponsesInputTokensDetails, ResponsesObject, ResponsesOutput,
        ResponsesOutputTokensDetails, ResponsesTextConfig, ResponsesTextFormat, ResponsesUsage,
