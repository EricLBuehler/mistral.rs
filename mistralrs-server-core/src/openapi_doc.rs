...
use crate::{
    ...
    openai::{
        ...
        ResponsesMessages, ResponsesObject, ResponsesPromptDetails, ResponsesPromptTokensDetails,
        ResponsesTopLogprob, ResponsesUsage, SpeechGenerationRequest, StopTokens, ToolCall,
    },
