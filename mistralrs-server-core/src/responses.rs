...
pub async fn create_response(
    ...
    if background {
        ...
        tokio::spawn(async move {
            ...
            // Wait for response. When stream=true, the engine sends
            // Response::Chunk events before the terminal Response::Done.
            // We must drain the chunks to reach the final result.
