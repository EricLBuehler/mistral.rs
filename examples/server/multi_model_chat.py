...
def compare_models_example():
    ...
    if len(models) < 2:
        print("Need at least 2 models loaded for comparison. Please start the server with multiple models.")
        return
    
    # Test prompt
    messages = [
        {"role": "system", "content": "You are a helpful assistant."},
        {"role": "user", "content": "What are the main benefits of using renewable energy?"}
    ]
...
def model_specific_tasks_example():
    ...
    technical_messages = [
        ...
        {"role": "user", "content": "Explain how a transformer neural network works in simple terms."}
    ]
...
if __name__ == "__main__":
    try:
        ...
        print("  mistralrs-server --port 1234 --multi-model --multi-model-config example-multi-model-config.json")
        exit(1)
