...
from mistralrs import Runner, Which, ChatCompletionRequest, Architecture, MultiModelRunner
import sys
...
def test_multi_model_operations():
    ...
    try:
        ...
        if models:
            ...
            print(f"   ✓ Response from specific model: {response.choices[0].message.content}")
