...
**Video frame sampling defaults.** Long videos at the default sampling rate produce many tokens; adjust with request-level video options (see the [HTTP API reference](/mistral.rs/reference/http-api/)).
