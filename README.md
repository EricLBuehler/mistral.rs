...
40+ model families: text (Llama, Qwen 3, GLM, DeepSeek, GPT-OSS, Granite, Liquid LFM2, and more), multimodal (Gemma 4, Qwen 3-VL, LFM2-VL, Llama 4, Phi 4 multimodal, and more), speech (Voxtral ASR, Dia), image generation (FLUX), and embeddings (Embedding Gemma, Qwen 3 Embedding).
