...
use crate::args::{
    AdapterOptions, AgentCliOptions, CacheOptions, CodeExecPermissionArg, DeviceOptions,
    FormatOptions, GlobalOptions, MatformerSelection, ModelFormat, ModelSourceOptions, ModelType,
...
pub(crate) fn convert_to_model_selected(
    ...
    match model_type {
        ...
        ModelType::Text {
            ...
            device,
            cache,
        } => convert_text_model(model, format, adapter, quantization, device, cache, matformer),
