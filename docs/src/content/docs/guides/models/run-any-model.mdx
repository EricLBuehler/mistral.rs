...
Most models need nothing beyond `-m`. The exceptions (thinking tags, MoE quantization, template fixes, MatFormer slices) are collected in [model family notes](/mistral.rs/guides/models/model-family-notes/).
