...
Qwen3-VL, Gemma 4, and the native Muse Glimmer safetensors checkpoint accept video; see the [supported models reference](/mistral.rs/reference/supported-models/) for per-model modality support. [Full example](/mistral.rs/examples/server/gemma4-video/).
