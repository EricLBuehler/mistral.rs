...
LiquidAI LFM2 checkpoints mix attention layers with short-conv recurrent layers. LFM2-VL uses the same text backbone with a SigLIP2 vision tower and accepts image input.
