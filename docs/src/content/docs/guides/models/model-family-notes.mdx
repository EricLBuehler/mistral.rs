...
## LFM2.5 and LFM2.5-VL

LiquidAI LFM2.5 checkpoints mix attention layers with short-conv recurrent layers. LFM2.5-VL uses the same text backbone with a SigLIP2 vision tower and accepts image input.
