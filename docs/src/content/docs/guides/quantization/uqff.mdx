...
precedence. The active model loader declares the exact tensors covered by this policy; similarly
named tensors in vision, audio, or auxiliary subtrees are not promoted implicitly.
