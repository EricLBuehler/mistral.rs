...
CUDA compute capability variants: `80` (A100), `86` (A-series workstation/RTX 30), `89` (RTX 40/L4), `90` (H100), `100` (B200), `120` (RTX 50), `121` (DGX Spark). See [hardware support](/mistral.rs/reference/hardware-support/) for the full GPU mapping. The `*-latest` tags publish on releases and on manual CI dispatch from master; version tags pin a release.
