...
projectors follow the [GGUF selection rules](/mistral.rs/guides/models/run-gguf/).
...
[GGUF guide](/mistral.rs/guides/models/run-gguf/) covers automatic CLI selection.
...
[GGUF support reference](/mistral.rs/reference/gguf-support/).
