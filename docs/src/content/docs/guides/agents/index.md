...
mistral.rs can run the entire tool-calling loop server-side, execute Python, shell commands, and web searches locally, use OpenAI-compatible Skills, and stream model text, tool progress, files, and media from one request.
