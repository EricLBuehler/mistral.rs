...
The loop's fallback cap is 256 tool rounds unless `--max-tool-rounds` says otherwise. On Linux and macOS, code execution is [sandboxed by default](/mistral.rs/reference/sandbox/) (`--sandbox auto`).
