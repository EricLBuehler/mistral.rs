...
| `MISTRALRS_GDN_PREFILL_KERNEL` | Overrides the CUDA GDN prefill kernel. Accepted values are `auto` (default), `vmajor1`, `vmajor2`, `vmajor4`, `vmajor8`, `legacy-chunked`, and `flashinfer-sm90` (Hopper builds only). |
