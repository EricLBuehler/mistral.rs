...
| [`mistralrs login`](/mistral.rs/reference/cli/login/) | Authenticate with Hugging Face Hub |
| [`mistralrs cache`](/mistral.rs/reference/cli/cache/) | Manage the Hugging Face model cache |
