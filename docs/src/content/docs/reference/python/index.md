...
pip install "mistralrs==0.8.20+cuda128.sm89" \          # NVIDIA (replace version, CUDA level, and SM)
  --find-links https://github.com/EricLBuehler/mistral.rs/releases/expanded_assets/v0.8.20
```
