...
| Expose an OpenAI-compatible endpoint or Anthropic Messages API | [Serve a model as an API](/mistral.rs/tutorials/02-serve-an-api/) | [Serve models](/mistral.rs/guides/serve/) |
...
| HTTP server | You want OpenAI-compatible clients, Anthropic-compatible clients, a web UI, or a process boundary around inference. | `mistralrs serve` |
