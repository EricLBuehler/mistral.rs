---
title: "Simple test script to verify multi-model functionality in mistral.rs"
description: "Simple test script to verify multi-model functionality in mistral.rs"
sidebar:
