---
title: "Example demonstrating multi-model usage with mistral.rs Python bindings"
description: "Example demonstrating multi-model usage with mistral.rs Python bindings"
sidebar:
