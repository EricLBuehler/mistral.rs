...
Source: [`mistralrs/examples/cookbook/structured/main.rs`](https://github.com/EricLBuehler/mistral.rs/blob/master/mistralrs/examples/cookbook/structured/main.rs)
