---
title: "MCP (Model Context Protocol) client usage with mistral.rs"
description: "MCP (Model Context Protocol) client usage with mistral.rs"
sidebar:
  label: "mcp_client"
---
...
Source: [`mistralrs/examples/advanced/mcp_client/main.rs`](https://github.com/EricLBuehler/mistral.rs/blob/master/mistralrs/examples/advanced/mcp_client/main.rs)
