---
title: "LiquidAI LFM2-VL image understanding through the OpenAI-compatible HTTP API"
description: "LiquidAI LFM2-VL image understanding through the OpenAI-compatible HTTP API"
sidebar:
  label: "lfm2_vl"
---
