---
title: "Anthropic-style server tools mapped to mistral.rs agentic features"
description: "Anthropic-style server tools mapped to mistral.rs agentic features"
sidebar:
