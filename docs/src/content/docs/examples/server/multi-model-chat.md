---
title: "Example demonstrating multi-model usage with mistral.rs server HTTP API"
description: "Example demonstrating multi-model usage with mistral.rs server HTTP API"
sidebar:
