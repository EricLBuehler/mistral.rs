---
title: "Compare a routed MoE LoRA adapter with its base model"
description: "Compare a routed MoE LoRA adapter with its base model"
sidebar:
  label: "moe_lora_smoke"
---
...
Source: [`examples/server/moe_lora_smoke.py`](https://github.com/EricLBuehler/mistral.rs/blob/master/examples/server/moe_lora_smoke.py)
