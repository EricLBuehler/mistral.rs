...
Already have a GGUF? Pass the file directly, or let mistral.rs choose a published variant:
...
The file suffix selects GGUF automatically. Compatible repositories also provide the tokenizer,
configuration, chat template, and multimodal projector without extra flags.
