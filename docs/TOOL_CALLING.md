...
- **Gemma 4** — e.g. `google/gemma-4-E4B-it` (multimodal; Harmony-style tools; see [examples/server/gemma4.py](https://github.com/EricLBuehler/mistral.rs/blob/master/examples/server/gemma4.py))
- Llama 4
- Llama 3.1/3.2/3.3
...
### HTTP API
- [Gemma 4 tool calling](https://github.com/EricLBuehler/mistral.rs/blob/master/examples/server/gemma4.py)
