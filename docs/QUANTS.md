...
- Mistral.rs will automatically detect and use GPTQ quantization for plain and multimodal models!
...
- Mistral.rs will automatically detect and use quantization for plain and multimodal models!
