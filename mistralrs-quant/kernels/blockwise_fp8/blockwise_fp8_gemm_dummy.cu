...
extern "C" void launch_fp8_matmul_f16(
    ...
    fprintf(stderr, "FP8 matmul not supported on this GPU (requires compute capability >= 8.0)\n");
}
...
extern "C" void launch_fp8_indexed_moe_gemm_f16(
    ...
    fprintf(stderr, "FP8 indexed MoE GEMM not supported on this GPU (requires compute capability >= 8.0)\n");
}
