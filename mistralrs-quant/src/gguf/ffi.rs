...
extern "C" {
    ...
    pub fn launch_moe_gemv_fused_gate_up_q8_0_q8_1(
        gate_weights: *const c_void, up_weights: *const c_void,
        all_inputs: *const c_void, indices: *const u32,
        all_outputs: *mut f32, n: i32, k: i32, batch: i32,
        topk: i32, k_padded: i32, act_type: i32, stream: *mut c_void,
    );
    ...
    pub fn launch_moe_gemv_down_aggregate_q8_0_q8_1(
        all_weights: *const c_void, all_inputs: *const c_void,
        indices: *const u32, topk_weights: *const f32,
        all_outputs: *mut f32, n: i32, k: i32, batch: i32,
        topk: i32, k_padded: i32, stream: *mut c_void,
    );
