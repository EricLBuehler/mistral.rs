...
impl Kernels {
    ...
    fn compile_kernels_at_runtime(&self, device: &Device) -> Result<Library, MetalKernelError> {
        const METAL_SOURCES: &[(&str, &str)] = &[
            ("bitwise", include_str!("bitwise.metal")),
            ("blockwise_fp8", include_str!("blockwise_fp8.metal")),
            ("bnb_dequantize", include_str!("bnb_dequantize.metal")),
            ("hqq_dequantize", include_str!("hqq_dequantize.metal")),
            ("quantized", include_str!("quantized.metal")),
            ("scan", include_str!("scan.metal")),
            ("sort", include_str!("sort.metal")),
            ("copy", include_str!("copy.metal")),
            ("utils", include_str!("utils.metal")),
            ("bf16", include_str!("bf16.metal")),
            ("scan_impl", include_str!("scan_impl.metal")),
            ("sort_impl", include_str!("sort_impl.metal")),
            ("copy_impl", include_str!("copy_impl.metal")),
        ];
