...
#define instantiate_bitwise_or(type)                           \
  template [[host_name("bitwise_or_" #type)]]                  \
...
#define instantiate_bitwise_leftshift(type)                           \
  template [[host_name("bitwise_leftshift_" #type)]]                  \
  [[kernel]] void bitwise_leftshift<type>(                            \
    const device type* a [[buffer(0)]],                               \
