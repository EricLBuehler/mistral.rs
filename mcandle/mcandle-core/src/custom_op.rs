...
impl InplaceOp1 for UgIOp1 {
    ...
    fn metal_fwd(&self, sto: &mut MetalStorage, layout: &Layout) -> Result<()> {
        ...
        use mcandle_metal_kernels::utils::EncoderProvider;
        ...
        let group_dims = mcandle_metal_kernels::utils::get_block_dims(b as u64, 1, 1);
        mcandle_metal_kernels::utils::set_param(encoder, 0, (sto.buffer(), 0usize));
