...
impl QMetalStorage {
    ...
    fn fwd_mv(
        ...
        // second dimension as the implementation in mcandle-metal-kernels doesn't handle batch
        // properly.
        ...
        for batch_id in 0..m {
            mcandle_metal_kernels::call_quantized_matmul_mv_t(
                device.device(),
                &command_buffer,
                device.kernels(),
                self.dtype.into(),
    ...
    pub fn fwd(
        ...
        mcandle_metal_kernels::call_quantized_matmul_mm_t(
            device.device(),
            &command_buffer,
            device.kernels(),
            self.dtype.into(),
...
impl From<GgmlDType> for mcandle_metal_kernels::GgmlDType {
    fn from(value: GgmlDType) -> Self {
        match value {
            GgmlDType::Q4_0 => mcandle_metal_kernels::GgmlDType::Q4_0,
            GgmlDType::Q4_1 => mcandle_metal_kernels::GgmlDType::Q4_1,
            GgmlDType::Q5_0 => mcandle_metal_kernels::GgmlDType::Q5_0,
            GgmlDType::Q5_1 => mcandle_metal_kernels::GgmlDType::Q5_1,
            GgmlDType::Q8_0 => mcandle_metal_kernels::GgmlDType::Q8_0,
            GgmlDType::Q8_1 => mcandle_metal_kernels::GgmlDType::Q8_1,
            GgmlDType::Q2K => mcandle_metal_kernels::GgmlDType::Q2K,
            GgmlDType::Q3K => mcandle_metal_kernels::GgmlDType::Q3K,
            GgmlDType::Q4K => mcandle_metal_kernels::GgmlDType::Q4K,
            GgmlDType::Q5K => mcandle_metal_kernels::GgmlDType::Q5K,
            GgmlDType::Q6K => mcandle_metal_kernels::GgmlDType::Q6K,
            GgmlDType::Q8K => mcandle_metal_kernels::GgmlDType::Q8K,
            GgmlDType::F16 => mcandle_metal_kernels::GgmlDType::F16,
            GgmlDType::F32 => mcandle_metal_kernels::GgmlDType::F32,
            GgmlDType::BF16 => mcandle_metal_kernels::GgmlDType::F16,
        }
    }
}
