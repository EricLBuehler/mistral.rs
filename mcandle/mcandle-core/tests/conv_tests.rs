use anyhow::Result;
use mcandle_core::{test_device, test_utils, Device, IndexOp, Tensor};
...
fn conv2d_grad(dev: &Device) -> Result<()> {
    ...
    // Replicate the issue from https://github.com/huggingface/mcandle/issues/1212
