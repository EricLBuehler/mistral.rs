...
use mcandle_core::test_utils::{to_vec0_round, to_vec2_round};

use anyhow::Result;
use mcandle_core::{DType, Device, Tensor, Var};
use mcandle_nn::{AdamW, Linear, Module, Optimizer, ParamsAdamW, SGD};
...
fn adamw_linear_regression_varmap() -> Result<()> {
    ...
    let mut var_map = mcandle_nn::VarMap::new();
