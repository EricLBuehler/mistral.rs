...
display_model_id = input("Please enter the model ID where this model card will be displayed: ")
...
try:
    n = 0
    while True:
        print(f" NOTE: Next file. Have processed {n} files. Press CTRL-C now if there are no more.")
