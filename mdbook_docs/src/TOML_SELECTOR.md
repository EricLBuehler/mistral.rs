...
Mistral.rs supports loading models from a .toml file, and the fields are the same as for the CLI. Please find some example toml selectors [here](https://github.com/EricLBuehler/mistral.rs/tree/main/toml-selectors).
