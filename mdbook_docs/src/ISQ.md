...
This is commonly measured with perplexity. Please see the [perplexity](https://github.com/EricLBuehler/mistral.rs/blob/main/mistralrs/examples/perplexity/README.md) example.
...
## Rust Example
You can find this example [here](https://github.com/EricLBuehler/mistral.rs/blob/main/mistralrs/examples/isq/main.rs).
