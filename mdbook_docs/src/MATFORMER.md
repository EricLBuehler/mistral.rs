...
See [`matformer_configs/`](https://github.com/EricLBuehler/mistral.rs/tree/main/matformer_configs) for available configurations.
...
- [Example Configurations](https://github.com/EricLBuehler/mistral.rs/tree/main/matformer_configs)
