...
## Examples
- Python
    - Text models [text_auto_device_map.py](https://github.com/EricLBuehler/mistral.rs/blob/main/examples/python/text_auto_device_map.py)
    - Vision models [vision_auto_device_map.py](https://github.com/EricLBuehler/mistral.rs/blob/main/examples/python/vision_auto_device_map.py)
- Rust
    - Text models [text_auto_device_map/main.rs](https://github.com/EricLBuehler/mistral.rs/blob/main/mistralrs/examples/text_auto_device_map/main.rs)
    - Vision models [vision_auto_device_map/main.rs](https://github.com/EricLBuehler/mistral.rs/blob/main/mistralrs/examples/vision_auto_device_map/main.rs)
- Server
    - Text models: 
    ```
