...
Please see [our example here](https://github.com/EricLBuehler/mistral.rs/blob/main/examples/server/tool_calling.py).

> OpenAI docs: https://platform.openai.com/docs/api-reference/chat/create?lang=curl

## Rust example
Please see [our example here](https://github.com/EricLBuehler/mistral.rs/blob/main/mistralrs/examples/tools/main.rs).

## Python example
Please see [our notebook here](https://github.com/EricLBuehler/mistral.rs/blob/main/examples/python/tool_calling.ipynb).
...
See [local_tool_search.py](https://github.com/EricLBuehler/mistral.rs/blob/main/examples/python/local_tool_search.py) for a full
example. In Rust pass `.with_tool_callback(...)` to the builder as demonstrated
in [local_search/main.rs](https://github.com/EricLBuehler/mistral.rs/blob/main/mistralrs/examples/local_search/main.rs).
