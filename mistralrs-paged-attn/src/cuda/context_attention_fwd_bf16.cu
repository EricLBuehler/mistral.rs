...
extern "C" void context_attention_fwd_bf16(
  ...
  if (cache_dtype == 3) {
    CALL_CTX_ATTN_LAUNCHER_BLOCK_SIZE(__nv_bfloat16, uint8_t,
                                      vllm::Fp8KVCacheDataType::kFp8E4M3);
  } else {
    CALL_CTX_ATTN_LAUNCHER_BLOCK_SIZE(__nv_bfloat16, __nv_bfloat16,
