...
extern "C" {
    ...
    pub fn context_attention_fwd_f16(
        out: *const c_void,
        query: *const c_void,
        key: *const c_void,
        value: *const c_void,
        ...
        block_tables: *const c_int,
        context_lens: *const c_int,
        query_lens: *const c_int,
        query_start_locs: *const c_int,
        seq_ids: *const c_int,
        max_num_blocks_per_seq: c_int,
        total_new_tokens: c_int,
        num_heads: c_int,
        head_size: c_int,
        block_size: c_int,
        kv_block_stride: c_int,
        ...
        sinks: *const f32,
        max_total_kv_len: c_int,
    );

    pub fn context_attention_fwd_bf16(
        out: *const c_void,
        query: *const c_void,
        key: *const c_void,
        value: *const c_void,
    ...
    pub fn context_attention_fwd_f32(
        out: *const c_void,
        query: *const c_void,
        key: *const c_void,
        value: *const c_void,
    ...
    pub fn context_attention_fwd_v2_f16(
        out: *const c_void,
        exp_sums: *const f32,
        max_logits: *const f32,
        tmp_out: *const c_void,
        ...
        sinks: *const f32,
        max_total_kv_len: c_int,
        max_num_partitions: c_int,
    );

    pub fn context_attention_fwd_v2_bf16(
        out: *const c_void,
        exp_sums: *const f32,
        max_logits: *const f32,
        tmp_out: *const c_void,
    ...
    pub fn context_attention_fwd_v2_f32(
        out: *const c_void,
        exp_sums: *const f32,
        max_logits: *const f32,
        tmp_out: *const c_void,
